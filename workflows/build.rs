...
use walkdir::WalkDir;
use shellbox_workflows_types::Workflow;
...
/// ```ignore
/// use shellbox_workflows_metadata::*;
...
fn write_workflow(workflow: Workflow, file_name: &str) -> Result<()> {
    ...
    writeln!(&module, "use shellbox_workflows_types::*;")?;
